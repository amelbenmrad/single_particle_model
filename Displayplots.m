...
figure
hold all
plot(x * 1e6, C1(t == 1, :), 'LineWidth', 2)          %find(t==1) cherche la colonne ou t=1 peu importe si on change le pas
plot(x * 1e6, C1(t == 5, :), 'k--', 'LineWidth', 2)
plot(x * 1e6, C1(t == 10, :), 'm:', 'LineWidth', 2)
plot(x * 1e6, C1(t == 100, :), 'g', 'LineWidth', 2)
...
figure
hold all
plot(x * 1e6, C2(t == 1, :), 'LineWidth', 2)
plot(x * 1e6, C2(t == 5, :), 'LineWidth', 2)
plot(x * 1e6, C2(t == 10, :), 'k--', 'LineWidth', 2)
plot(x * 1e6, C2(t == 100, :), 'm:', 'LineWidth', 2)
legend('t = 1 s', 't = 5 s', 't = 10 s', 't = 100 s')
xlabel('Particle radius (µm)', 'fontsize', 12, 'fontweight', 'b', 'fontname', 'arial')
...
figure
hold all
plot(x * 1e6,T(t == 1, :) - 273, 'LineWidth', 2)
plot(x * 1e6,T(t == 5, :) - 273, 'k--', 'LineWidth', 2)
plot(x * 1e6,T(t == 10, :) - 273, 'm:', 'LineWidth', 2)
plot(x * 1e6,T(t == 100, :) - 273, 'g:', 'LineWidth', 2)
legend('t = 1 s', 't = 5 s', 't = 10 s', 't = 100 s')
xlabel('Particle radius (µm)', 'fontsize', 12, 'fontweight', 'b', 'fontname', 'arial')
